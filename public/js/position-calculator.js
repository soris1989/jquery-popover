...
(function (factory) {
    ...
    function __calculateRefpointOffsets(pos, extraOffsets, initialRefpoint) {
        ...
        if (extraOffsets.y !== 0) {
            ...
            if (extraOffsets.mirror) {
                ...
                result.bottom +=
                    "bottom" !== initialRefpoint.y ? extraOffsets.y * -1 : extraOffsets.y;
            } else {
        ...
        if (extraOffsets.x !== 0) {
            ...
            if (extraOffsets.mirror) {
                ...
                result.right +=
                    "right" !== initialRefpoint.x ? extraOffsets.x * -1 : extraOffsets.x;
            } else {
    ...
    PositionCalculator.prototype._init = function (options) {
        ...
        this.$bnd =
            o.boundary && o.boundary.jquery ? o.boundary : $(__normalizeSlector(o.boundary));
